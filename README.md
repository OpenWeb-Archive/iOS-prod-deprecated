...
1. Download the [Spot_IM.framework Universal](hhttps://github.com/SpotIM/iOS-prod/files/1639390/Spot_IM.framework.zip) (for  development) You can use this Version for compiling on any device + Simulator.
